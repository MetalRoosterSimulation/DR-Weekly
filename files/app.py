...
# ─────────────────────────────────────────────
COLUMN_CONFIG = {
    "partner":      "Partner",        # column header for partner name
    "customer":     "Customer",       # column header for customer name
    "sales_price":  "Sales Price",    # column header for sales price
    "close_date":   "Est. Close Date",# column header for estimated close date
    "created_date": "Created Date",   # column header for created date (used for filtering)
}
